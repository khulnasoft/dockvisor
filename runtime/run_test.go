...
import (
	...
	"github.com/khulnasoft/dockvisor/dockvisor/image/docker"
)
...
func TestRun(t *testing.T) {
	table := map[string]struct {
		...
		"fetch-case": {
			...
			options: Options{
				Ci:         false,
				Image:      "dockvisor-example",
				Source:     dockvisor.SourceDockerEngine,
				ExportFile: "",
				CiConfig:   nil,
				BuildArgs:  nil,
			},
			events: []testEvent{
				{stdout: "Image Source: docker://dockvisor-example", stderr: "", errorOnExit: false, errMessage: ""},
