...
import (
	...
	"github.com/khulnasoft/dockvisor/runtime/ci"
	"github.com/khulnasoft/dockvisor/runtime/export"
	"github.com/khulnasoft/dockvisor/runtime/ui"
	"github.com/khulnasoft/dockvisor/utils"
)
...
func Run(options Options) {
	...
	imageResolver, err := dockvisor.GetImageResolver(options.Source)
	if err != nil {
